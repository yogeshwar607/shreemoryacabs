...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: 'shreemoryacabs-vs-grel-detailed-comparison',
    title: 'Shree Morya Cabs vs Grel Cabs: Honest Detailed Comparison 2025',
    description: 'Unbiased comparison between Shree Morya Cabs and Grel Cabs. Pricing, fleet, service quality, and customer reviews.',
    publishDate: '2024-12-05',
    author: 'Shree Morya Cabs Team',
    category: 'comparison',
    tags: ['service comparison', 'grel cabs', 'shreemoryacabs'],
    readTime: '8 min read',
    keywords: ['shreemoryacabs vs grel', 'best ev cab service', 'cab service comparison'],
    featured: false,
    schema: 'Article'
  },
  {
